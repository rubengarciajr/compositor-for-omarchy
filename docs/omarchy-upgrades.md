...
| Files | `.comp` projects via native Save / Save As / Open dialogs, Layer › Add Image… to bring image files in as layers, `compositor photo.png` from the terminal, several documents open at once. |
