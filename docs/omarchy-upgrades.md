...
| Files | `.comp` projects via native Save / Save As / Open dialogs, Layer › Add Image… to bring image files in as layers (transparent padding trimmed on import; Layer › Trim Transparent Pixels at any time), `compositor photo.png` from the terminal, several documents open at once. |
