# Compositor for macOS

> This is the original README of [Compositor for macOS](https://robbietilton.com/compositor) by [Robbie Tilton](https://github.com/robbietilton/Compositor) (Wonder Assembly LLC), kept as shipped upstream. The Linux port that this repository is about is described in the [main README](README.md) and [`linux/README.md`](linux/README.md).
